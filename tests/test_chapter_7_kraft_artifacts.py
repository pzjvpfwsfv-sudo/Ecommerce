...
class Chapter7KRaftArtifactsTest(unittest.TestCase):
    ...
    def test_compose_defines_controller_and_broker_without_zookeeper(self) -> None:
        ...
        self.assertIn("KAFKA_CFG_LISTENERS: CONTROLLER://:9093,PLAINTEXT://:29092", text)
        self.assertIn("KAFKA_CFG_ADVERTISED_LISTENERS: PLAINTEXT://kafka:29092", text)
        ...
        self.assertIn("1 controller", text)
        self.assertIn("1 broker", text)
